...
export MASTER_PORT=31883
export TF_CPP_MIN_LOG_LEVEL=3
export LAUNCHER=pytorch
export number=4
OUTPUT_DIR="weights2/st2/mos${number}_st2"
...
torchrun \
  ...
  train/stage2_train_AIGV.py \
   --model_name_or_path "/media/amax/3f3218fe-d2fb-4962-bb1f-115b03978aba/wjr/ICCVW/weights/st1/mos${number}_st1" \
